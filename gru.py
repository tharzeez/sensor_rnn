...
data_dir = "./"
pd.read_csv(data_dir + 'interpolated_df.csv').head()
...
df = pd.read_csv('pm10_amar_2500.csv', parse_dates=[0])
df.head(10)
...
print('len ip', len(inputs))
print('len labels', len(labels))
print('labels', inputs[0:10])
...
test_y['amar'] = (labels[-test_portion:])
...
def train(train_loader, learn_rate, hidden_dim=256, EPOCHS=1, model_type="GRU"):
...
# savetxt('gru_outputs_epoch16.csv', gru_outputs, delimiter=',')
# savetxt('targets_epoch16.csv', targets, delimiter=',')
